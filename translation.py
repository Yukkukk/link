...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Shortnerfly than **contact** at 👉 @victorlctt (all **shortners** support available.)
'''
...
ABOUT_TEXT = '''**Hey! My name is @linktoearn. I am linktoearn Link Converter Bot.**
...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of ShortnerFly than **contact** at 👉 @victorlctt (all **shortners support** available.)
...
Ex: https://t.me/linktoearn | linktoearn"""
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://linktoearn.site)
...
Get API From [{base_site}](https://linktoearn.site)
...
USERNAME_TEXT = """**Hello victor, I am linktoearn.site, Bulk Link Converter Bot From Linked linktoearn.site Account,**
...
/channel @victorlctt
Or
/channel https://t.me/victorlctt

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @victorlctt For More Help -**"""
